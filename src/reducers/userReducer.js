...
export const userDeleteReducer = (state = { user: {}, loading: true }, action) => {
    switch (action.type) {
        case USER_DELETE_REQUEST:
            return { loading: true };
        case USER_DELETE_SUCCESS:
            return { loading: false, user: action.payload, successUserDelete: true };
        case USER_DELETE_FAIL:
            return { loading: false, error: action.payload, successUserDelete: false };
        default:
            return state;
    }
}