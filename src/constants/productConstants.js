...
export const PRODUCT_LIST_FEATURE_REQUEST = 'PRODUCT_LIST_FEATURE_REQUEST';
export const PRODUCT_LIST_FEATURE_SUCCESS = 'PRODUCT_LIST_FEATURE_SUCCESS';
export const PRODUCT_LIST_FEATURE_FAIL = 'PRODUCT_LIST_FEATURE_FAIL';
